...
const Hero = () => {
    return (
        <section className="bg-[#e7f8ee] px-4 2xl:px-0">
            <div className="max-w-[1440px] flex flex-col lg:flex-row items-center justify-between mx-auto pt-20 relative">
                <div className="z-20">
                    ...
                    <div className="relative lg:max-w-[410px]">
                        <h2 className="text-[40px] mt-6 font-semibold">Now learning from anywhere, and build your <span className="text-[#309255]">bright career.</span></h2>
                    ...
                    <button className="mt-7 bg-[#309255] px-6 py-4 text-white rounded-md">Start A Course</button>
                </div>
                <div className="z-20">

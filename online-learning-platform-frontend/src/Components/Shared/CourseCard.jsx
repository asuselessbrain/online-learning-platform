        ...
        <div className="border border-[rgba(48,146,85,0.2)] hover:border-[#309255] rounded-xl p-6 transition-all duration-700 h-auto!">
            ...
            <div className="flex items-center justify-between mt-6 mb-4">
                <div className="flex items-center gap-4">
                    <img src={course?.instructor?.photoUrl} alt="Arfan Ahmed Name" className="rounded-full h-10 w-10" />
                    <h4 className="text-gray-500">{course?.instructor?.name}</h4>
                </div>
                <p className="py-2 px-4 rounded-md text-[#309255] hover:text-white bg-[#eefbf3] hover:bg-[#309255] transition-all duration-700">{course?.category?.name}</p>
            </div>
            ...
            <div className="bg-[#eefbf3] p-4 rounded-lg mt-6 flex items-center justify-between gap-10">
                <div className="flex items-center gap-2">
                    <h2 className="text-[#309255] font-semibold">{course?.discountedPrice} Tk</h2>
                    <h2 className="line-through text-gray-500 text-sm">{course?.price} Tk</h2>
                </div>

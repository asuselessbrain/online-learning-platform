        ...
        <section className="bg-[#e7f8ee] px-4 2xl:px-0">
            <div className="max-w-[1440px] mx-auto py-30 flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="max-w-[415px]">
                    ...
                    <h2 className="text-[40px] mt-6">You can join with Edule as <span className="text-[#309255]">a instructor?</span></h2>
                ...
                <div>
                    <button className="mt-7 bg-[#309255] px-6 py-4 text-white rounded-md">Drop Information</button>
                </div>
            </div>
        </section>
    );

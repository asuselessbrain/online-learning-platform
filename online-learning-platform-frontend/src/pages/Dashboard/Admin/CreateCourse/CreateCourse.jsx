...
const CreateCourse = () => {
    ...
    return (
        <div className="p-6">
            <PageHeading title="Add New Course" subtitle="Create a new course for the platform" />
            ...
            >
                ...
                {/* Thumbnail */}
                <div>
                    <label className="block text-sm text-[#4A5565] mb-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        >
                            <option value="">
                                {instructorLoading ? 'Loading instructors...' : 'Select Instructor'}
                            </option>
                ...
                <div>
                    <label className="text-sm text-[#4A5565]">
                        Learning Outcomes (separate with comma) <span className="text-red-500">*</span>
                    </label>
                    <textarea
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows="2"
                        className="border border-[#E5E7EB] p-2 rounded-md block w-full mt-2"
                        placeholder="Who is this course for? Separate each targetAudience with a comma"
                    />
                </div>
                ...
                <div className="pt-4">
                    <input
                        type="submit"
                        value={loading ? 'Creating...' : 'Create Course'}
                        disabled={loading}

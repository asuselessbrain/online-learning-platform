        ...
        <section className="flex items-center justify-center min-h-screen p-6 dark:bg-black dark:text-white transition-colors duration-300">
            <div className="max-w-5xl border border-[rgba(48,146,85,0.2)] mx-auto rounded-xl xl:p-16 w-full p-8 flex items-center justify-between gap-8 lg:gap-16 dark:border-gray-700 dark:bg-gray-900 transition-colors duration-300 z-10">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-16">
                        <form>
                            <input type="email" placeholder="Usename or Email" className="block p-4 rounded-xl border border-[rgba(48,146,85,0.2)] focus:outline-none focus:ring-0 focus:border-[rgba(48,146,85,0.2)] w-full mb-6 dark:bg-gray-800 dark:border-gray-700 dark:text-white 
                            transition-colors duration-300" />

                            <input type="password" placeholder="Password" className="block p-4 rounded-xl border border-[rgba(48,146,85,0.2)] focus:outline-none focus:ring-0 focus:border-[rgba(48,146,85,0.2)] w-full dark:bg-gray-800 dark:border-gray-700 dark:text-white 
                            transition-colors duration-300" />
                            ...
                            <button className="bg-[#e7f8ee] dark:bg-gray-800 w-full p-4 rounded-xl text-[#309255] dark:text-green-400 hover:bg-black/80 hover:text-white transition-all duration-700 cursor-pointer flex items-center gap-2 justify-center"><FcGoogle size={24} />Login With Google</button>
